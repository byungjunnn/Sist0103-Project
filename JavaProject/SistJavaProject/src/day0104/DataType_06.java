...
public class DataType_06 {
	...
	public static void main(String[] args) {
		...
		char ch='가'; //2.문자형, 반드시 하나의 문자, 16바이트 유니코드값 표현
					 //2바이트 문자 하나, 기본적으로 정수형, 아스키코드로 변경이 가능하므로
					 //''로 표현
		...
		short b=32000; //16bit
		int c=670000; //32bit
		long d=100L; //64bit 뒤에 L을 붙혀야 long인지 int인지를 의미
		
		//실수
		float f=3.1234f; //32bit 뒤에 f를 붙히지 않으면 double을 의미
		double dou=23456.1234567; //64bit 소수점을 가진 숫자 의미 double이 기본
